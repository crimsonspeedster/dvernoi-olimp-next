        ...
        <section className={styles['product-category-intro']}>
            <div className="container">
                ...
                <If condition={childrenCategories.length > 0}>
                    <Then>
                        <div className={styles['product-category-intro__slider-wrapper']}>
                            <Swiper
                                className={classNames(styles['product-category-intro__slider'], styles['product-category-intro-slider'])}
                            ...
                            >
                                {
                                    childrenCategories.map((item, i) => (
                                        <SwiperSlide key={i} className={styles['product-category-intro-slider__item']}>
